...
{
    "distutils": {
        "name": "Task_1_square_sum_cython",
        "sources": [
            "Task_1_square_sum_cython.pyx"
        ]
    },
    "module_name": "Task_1_square_sum_cython"
}
END: Cython Metadata */
...
#define __PYX_HAVE__Task_1_square_sum_cython
#define __PYX_HAVE_API__Task_1_square_sum_cython
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "Task_1_square_sum_cython" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "Task_1_square_sum_cython"
extern int __pyx_module_is_main_Task_1_square_sum_cython;
int __pyx_module_is_main_Task_1_square_sum_cython = 0;

/* Implementation of "Task_1_square_sum_cython" */
/* #### Code section: global_var ### */
/* #### Code section: string_decls ### */
/* #### Code section: decls ### */
static PyObject *__pyx_pf_24Task_1_square_sum_cython_sum_of_squares(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_n); /* proto */
...
#define __pyx_kp_u_Task_1_square_sum_cython_pyx __pyx_string_tab[1]
#define __pyx_n_u_Pyx_PyDict_NextRef __pyx_string_tab[2]
#define __pyx_n_u_Task_1_square_sum_cython __pyx_string_tab[3]
...
#define __pyx_kp_b_iso88591_A_U_1_Ba_1 __pyx_string_tab[22]
...
/* "Task_1_square_sum_cython.pyx":1
...
/* Python wrapper */
static PyObject *__pyx_pw_24Task_1_square_sum_cython_1sum_of_squares(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
static PyMethodDef __pyx_mdef_24Task_1_square_sum_cython_1sum_of_squares = {"sum_of_squares", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_24Task_1_square_sum_cython_1sum_of_squares, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_24Task_1_square_sum_cython_1sum_of_squares(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "sum_of_squares", 0) < (0)) __PYX_ERR(0, 1, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 1; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("sum_of_squares", 1, 1, 1, i); __PYX_ERR(0, 1, __pyx_L3_error) }
      }
  ...
  __Pyx_AddTraceback("Task_1_square_sum_cython.sum_of_squares", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_24Task_1_square_sum_cython_sum_of_squares(__pyx_self, __pyx_v_n);
...
static PyObject *__pyx_pf_24Task_1_square_sum_cython_sum_of_squares(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_n) {
  ...
  /* "Task_1_square_sum_cython.pyx":3
 * def sum_of_squares(int n):
 *     cdef long long i
 *     cdef long long result = 0             # <<<<<<<<<<<<<<
 *     for i in range(n):
...
*/
  ...
  /* "Task_1_square_sum_cython.pyx":4
 *     cdef long long i
 *     cdef long long result = 0
 *     for i in range(n):             # <<<<<<<<<<<<<<
 *         result += i * i
...
*/
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "Task_1_square_sum_cython.pyx":5
 *     cdef long long result = 0
 *     for i in range(n):
 *         result += i * i             # <<<<<<<<<<<<<<
 *     return result
*/
  ...
  /* "Task_1_square_sum_cython.pyx":6
 *     for i in range(n):
 *         result += i * i
 *     return result             # <<<<<<<<<<<<<<
*/
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_4 = __Pyx_PyLong_From_PY_LONG_LONG(__pyx_v_result); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 6, __pyx_L1_error)
...
static int __pyx_pymod_exec_Task_1_square_sum_cython(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_Task_1_square_sum_cython},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_Task_1_square_sum_cython(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_Task_1_square_sum_cython(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_Task_1_square_sum_cython(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'Task_1_square_sum_cython' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "Task_1_square_sum_cython" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_Task_1_square_sum_cython", 0);
  ...
  if (__pyx_module_is_main_Task_1_square_sum_cython) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "Task_1_square_sum_cython")) {
      if (unlikely((PyDict_SetItemString(modules, "Task_1_square_sum_cython", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
 ...
 *     cdef long long result = 0
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef